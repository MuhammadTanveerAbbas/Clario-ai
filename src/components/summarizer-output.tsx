...
export function SummarizerOutput({
  ...
  const handleDownloadPdf = () => {
    ...
    try {
      ...
      doc.save(
        `Clario-Summary-${mode.replace(/\s+/g, "-")}-${new Date().toISOString().slice(0, 10)}.pdf`,
      );
          ...
          <div className="summary-prose-modern p-6 sm:p-10 max-w-none text-gray-100">
            <ReactMarkdown
              ...
              components={{
                ...
                h2: ({ node, ...props }) => (
                  <h2
                    className="text-2xl font-semibold mt-8 mb-4 text-white flex items-center gap-2"
                    {...props}
                  />
                ),
                h3: ({ node, ...props }) => (
                ...
                code: ({ node, inline, ...props }: any) =>
                  inline ? (
                    ...
                    <code
                      className="block p-4 rounded-lg my-4 overflow-x-auto"
                      style={{
                        background: "var(--bg)",
                        color: "var(--success)",
                      }}
