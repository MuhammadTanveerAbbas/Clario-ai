...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    supabase.from("brand_voices").select("id, name, tone, vocabulary, personality, description, is_active, created_at").eq("user_id", authUser.id).eq("is_active", true).single()
