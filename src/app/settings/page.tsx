    ...
    <div className="flex min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      >
        <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
          {/* Header */}
          <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-r from-indigo-500/10 via-blue-500/5 to-cyan-500/5 border border-indigo-500/20">
            <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white to-indigo-200 bg-clip-text text-transparent mb-2">
              Settings
            </h1>
          ...
          <Tabs defaultValue="profile" className="space-y-4 md:space-y-6">
            <TabsList className="bg-white/5 border-white/10 w-full overflow-x-auto flex-nowrap justify-start">
              {TAB_TRIGGERS.map(({ value, label, icon: Icon }) => (
                <TabsTrigger
                  key={value}
                  value={value}
                  className="data-[state=active]:bg-white/10 text-xs md:text-sm"
                >
