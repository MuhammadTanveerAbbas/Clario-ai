        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://api.groq.com https://api.paddle.com https://app.posthog.com https://us.posthog.com https://eu.posthog.com https://*.sentry.io wss://*.sentry.io",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
